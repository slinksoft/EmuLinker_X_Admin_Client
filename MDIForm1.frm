...
Begin VB.MDIForm MDIForm1 
   ...
   BackColor       =   &H8000000C&
   Caption         =   "Emulinker X Admin Client"
   ClientHeight    =   10245
   ClientLeft      =   135
   ClientTop       =   480
   ClientWidth     =   15060
   ...
   Begin VB.Menu mnuHelp 
      Caption         =   "&Help"
      Begin VB.Menu mnuAboutEmulinkerXAC 
...
Private Sub MDIForm_Load()
    ...
    If GetAttr("EmulinkerX_Logs") And vbDirectory = False Then
        Call MkDir(App.Path & "\EmulinkerX_Logs")
    End If
    ...
    'incase file doesn't exist, make it
    Close #2
    Open App.Path & "\EmulinkerX_Logs\bot.txt" For Append As #2
        Print #2, "*****************************************"
        Print #2, "BOT LOG"
        Print #2, "*****************************************"
    ...
    'incase file doesn't exist, make it
    Close #3
    Open App.Path & "\EmulinkerX_Logs\chat.txt" For Append As #3
        Print #3, "*****************************************"
        Print #3, "CHAT LOG"
        Print #3, "*****************************************"
    ...
    'incase file doesn't exist, make it
    Close #5
    Open App.Path & "\EmulinkerX_Logs\gamechat.txt" For Append As #5
        Print #5, "*****************************************"
    ...
    Close #4
    Open App.Path & "\EmulinkerX_Logs\user.txt" For Append As #4
    Close #4
    Open App.Path & "\EmulinkerX_Logs\user.bak" For Append As #4
    Close #4
...
Private Sub mnuAboutEmulinkerXAC_Click()
    frmAbout.Show
