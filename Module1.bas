...
Public Const clientVersion As String = "3.1.3"
Public Const emulatorPass As String = "Emulinker X Admin Client v" & clientVersion
...
Sub serverInformationMessage(msgSlot As Byte)
    ...
    ElseIf StrComp(Left$(lMsg, Len(":access=")), ":access=", vbBinaryCompare) = 0 Then
        If Mid$(lMsg, Len(":access=") + 1, Len(msg) - Len(":access=")) = "super admin" Then 'Or Mid$(lMsg, Len(":access=") + 1, Len(msg) - Len(":access=")) = "admin" Then
