...
Sub saveUsers(Optional bak As Boolean = False)
    ...
    On Error Resume Next
        ...
        Close #4
        If bak = True Then
            Call FileCopy(App.Path & "\EmulinkerX_Logs\user.txt", App.Path & "\EmulinkerX_Logs\user.bak")
        ...
        frmServerlist.List1.TopIndex = frmServerlist.List1.ListCount - 1
            ...
            Open App.Path & "\EmulinkerX_Logs\user.txt" For Output As #4
...
Sub loadUsers()
    ...
    'Open App.Path & "\EmulinkerX_Logs\user.txt" For Input As #4
    '    Do Until EOF(4)
    '        Line Input #4, str
    '        i = i + 1
    '    Loop
    ...
    f1 = LOF(4)
    Close #4
    Open App.Path & "\EmulinkerX_Logs\user.bak" For Input As #4
    f2 = LOF(4)
    Close #4
